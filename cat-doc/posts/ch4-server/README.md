...
=======
    对程序运行盘下的/data/apps/cat/datas和/data/apps/cat/logs有读写权限。`例如cat服务运行在e盘的tomcat中，则需要对e:/data/apps/cat/datas和e:/data/apps/cat/logs有读写权限。`

>>>>>>> a46a1dd5c1f6579b813d32387ebd22ea74a99911
